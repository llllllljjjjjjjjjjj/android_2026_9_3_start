...
> 每新增/更新一个项目记录（projects/<target>.md）时，在此登记一行。projects/ 下还没有记录的项目不算「已分析」。

| 项目 | 记录文件 | 方案文档 | 平台 | 状态 | 最后更新 |
|---|---|---|---|---|---|
| ctrip | projects/ctrip.md | projects/ctrip/docs/risk-control-plan.md | Android | 方案已生成（签名已破，请求策略待对拍） | 2026-08-28 |
