...
This is a Python wrapper that provides a unified command-line interface.
It is adapted for Qoder platform usage on Windows.

For direct usage, run individual scripts: python scripts/<script_name>.py
"""
