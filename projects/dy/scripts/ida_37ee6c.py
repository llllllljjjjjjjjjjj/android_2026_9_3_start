# IDA 9.2: dump 37ee6c (FindHeader 调用者, 疑似头直写) + 其调用者 + 37f778 (SetHeader 调用者)
import ida_auto, ida_pro, ida_funcs, idautils, idc, ida_idaapi
import json, time

OUT = r"D:\reserve_agent\skills-portable-test\projects\dy\artifacts\ida_37ee6c.json"
FUNCS = [0x37ee6c, 0x37f778, 0x2a0eb4]
