...
OUT = r"D:\reserve_agent\skills-portable-test\projects\dy\artifacts\ida_25c6.json"
FUNCS = [0x25c624, 0x25c664]

def dump_func(fa, max_insns=2500):
...
def main():
    ...
    # 调用者
    for f in FUNCS:
        xr = list(idautils.XrefsTo(f, 0))
        result["callers_" + hex(f)] = [
